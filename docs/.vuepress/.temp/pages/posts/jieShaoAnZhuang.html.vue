<template><div><p><strong>01. ThinkPHP6.x</strong> <strong>入门开启</strong></p>
<p><strong>一．框架简介</strong></p>
<div class="language-TEXT line-numbers-mode" data-ext="TEXT" data-title="TEXT"><pre v-pre class="language-TEXT"><code>ThinkPHP6.0 发布于 2019 年 10 月 24 日；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>二．安装步骤</strong></p>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>官网不提供软件包下载，采用 Composer 下载和更新；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>三．测试运行</strong></p>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>在 cmd 命令行的项目目录中，输入运行命令；
php think run
